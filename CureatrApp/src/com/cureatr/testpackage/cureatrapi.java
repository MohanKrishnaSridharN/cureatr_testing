...
url = new URL("http://cureatr-vm.dev:5001/mtuity/create_user");
else
url = new URL(URL_BASE + host + ':' + port +"/InformationAnalyzer/" + command + params.toString());
