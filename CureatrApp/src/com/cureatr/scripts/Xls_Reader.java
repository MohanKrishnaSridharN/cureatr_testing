...
//returns true if data is set successfully else false
public boolean setCellInt(String sheetName,String colName,int rowNum, int number){
try{
fis = new FileInputStream(path); 
workbook = new HSSFWorkbook(fis);
...
datatable = new Xls_Reader("D:\\MohanJavaWorkSpace\\Cureatr\\src\\com\\Cureatr\\xls\\Login.xls");
